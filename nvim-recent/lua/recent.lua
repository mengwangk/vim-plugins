...
local function open_window()
  ...
  vim.api.nvim_buf_set_option(buf, 'filetype', 'recent')
  ...
  api.nvim_buf_add_highlight(buf, -1, 'RecentHeader', 0, 0, -1)
end
...
local function update_view(direction)
  ...
  api.nvim_buf_add_highlight(buf, -1, 'recentSubHeader', 1, 0, -1)
...
local function set_mappings()
  ...
  for k,v in pairs(mappings) do
    api.nvim_buf_set_keymap(buf, 'n', k, ':lua require"recent".'..v..'<cr>', {
